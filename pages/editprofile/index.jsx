...
export default function Editprofile() {
  ...
  const handleSubmit = async (e) => {
    ...
    fetch(`https://virtserver.swaggerhub.com/faqihassyfa/LesGoo/1.0.0/users`, requestOptions)
      .then((response) => response.json())
      .then((result) => {
        console.log(result);
    ...
    <>
      <div>
        <div className='w-full h-12 bg-[#1abc9c] flex items-center'>
          <MdArrowBack id='back-to-profile' className='absolute left-5' size={25} color='white' onClick={() => {route.push('/profile')}} />
        ...
        <div className='w-10/12 flex flex-col mx-auto items-center'>
          ...
          <form className='mt-12 mx-auto w-8/12' onSubmit={(e) => handleSubmit(e)}>
            <div className='mb-5'>
